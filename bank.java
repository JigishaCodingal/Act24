...
double[] accountBalance = new double[1000]; //this array will containthe account balance
String[] accountName = new String[1000]; //this array will contain theaccount holder's name
int option, size = 100;//size will be the first account you want tobegin from
//infinite loop to keep our program running untill we wish toend it.
while (infiniteLoop) {
System.out.println("Welcome to Codingal BankingServices");
...
System.out.println( "seeccssssssssessseseees==========" );
size = size + 1;
...
System.out.println("Name is successfully updated from " +
temp + " to "+ name +". \n");
}
System.out.println( "seeccssssssssessseseees==========" );
} else if (option == 4) {
...
System.out.println("=========s=sssssssssssssssssssss===");
} else if (option == 5) {
...
System.out.println("Built with W in India");
infiniteLoop=false; //instead of this "System.exit(@);" can also be used
} else {
System.out.println("\n Invalid input.");
System.out.println("Terminating...");
System.out.println("Developed & Managed by Aashish@Codingal");
